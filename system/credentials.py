try:
    ...
    DISPATCHER_CREDENTIALS, FETCHER_CREDENTIALS, JUDGE_CREDENTIALS
except ImportError:
...
class CredentialsProvider:
    ...
    def get_judge_credentials(self):
        return self.get_credentials('judge')
